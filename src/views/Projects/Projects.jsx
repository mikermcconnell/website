...
function Projects(props) {
    ...
    const cardVars1 = {
        ...
        bulletList: [
            "Created using Node.js with Express, React, PostgreSQL with Knex, and Socket.io.",
    ...
    const cardVars2 = {
        ...
        bulletList: [
            ...
            "The application makes API requests to load and persist data. Please note, can take a couple of minutes to load when running it the first time in a while.",
        ],
        link: "https://github.com/bregmanh/scheduler",
        deployed: "https://silly-brown-56f820.netlify.app/",
    }
